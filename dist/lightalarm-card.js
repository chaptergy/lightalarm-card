 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,n){const r=e[0];if("."===r){return new N(t,e.slice(1),i).parts}return"@"===r?[new M(t,e.slice(1),n.eventContext)]:"?"===r?[new C(t,e.slice(1),i)]:new x(t,e,i).parts}handleTextExpression(t){return new P(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const W=t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:n}=e;return{kind:i,elements:n,finisher(e){window.customElements.define(t,e)}}})(t,e),J=(t,e)=>"method"!==e.kind||!e.descriptor||"value"in e.descriptor?{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(i){i.createProperty(e.key,t)}}:Object.assign(Object.assign({},e),{finisher(i){i.createProperty(e.key,t)}});function Z(t){return(e,i)=>void 0!==i?((t,e,i)=>{e.constructor.createProperty(i,t)})(t,e,i):J(t,e)}function G(t){return Z({attribute:!1,hasChanged:null==t?void 0:t.hasChanged})}
/**
@license
...
const nt=(t,e)=>{const i=t.startNode.parentNode,n=void 0===e?t.endNode:e.startNode,r=i.insertBefore(c(),n);i.insertBefore(c(),n);const s=new P(t.options);return s.insertAfterNode(r),s},rt=(t,e)=>(t.setValue(e),t.commit(),t),st=(t,e,i)=>{const n=t.startNode.parentNode,r=i?i.startNode:t.endNode,s=e.endNode.nextSibling;s!==r&&((t,e,i=null,n=null)=>{for(;e!==i;){const i=e.nextSibling;t.insertBefore(e,n),e=i}})(n,e.startNode,s,r)},at=t=>{i(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},ot=(t,e,i)=>{const n=new Map;for(let r=e;r<=i;r++)n.set(t[r],r);return n},lt=new WeakMap,ct=new WeakMap,ut=(dt=(t,e,i)=>{let n;return void 0===i?i=e:void 0!==e&&(n=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const r=lt.get(e)||[],s=ct.get(e)||[],a=[],o=[],l=[];let c,u,d=0;for(const e of t)l[d]=n?n(e,d):d,o[d]=i(e,d),d++;let h=0,p=r.length-1,m=0,g=o.length-1;for(;h<=p&&m<=g;)if(null===r[h])h++;else if(null===r[p])p--;else if(s[h]===l[m])a[m]=rt(r[h],o[m]),h++,m++;else if(s[p]===l[g])a[g]=rt(r[p],o[g]),p--,g--;else if(s[h]===l[g])a[g]=rt(r[h],o[g]),st(e,r[h],a[g+1]),h++,g--;else if(s[p]===l[m])a[m]=rt(r[p],o[m]),st(e,r[p],r[h]),p--,m++;else if(void 0===c&&(c=ot(l,m,g),u=ot(s,h,p)),c.has(s[h]))if(c.has(s[p])){const t=u.get(l[m]),i=void 0!==t?r[t]:null;if(null===i){const t=nt(e,r[h]);rt(t,o[m]),a[m]=t}else a[m]=rt(i,o[m]),st(e,i,r[h]),r[t]=null;m++}else at(r[p]),p--;else at(r[h]),h++;for(;m<=g;){const t=nt(e,a[g+1]);rt(t,o[m]),a[m++]=t}for(;h<=p;){const t=r[h++];null!==t&&at(t)}lt.set(e,a),ct.set(e,l)}},(...t)=>{const e=dt(...t);return m.set(e,!0),e});var dt,ht=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,pt="[^\\s]+",mt=/\[([^]*?)\]/gm;function gt(t,e){for(var i=[],n=0,r=t.length;n<r;n++)i.push(t[n].substr(0,e));return i}var ft=function(t){return function(e,i){var n=i[t].map((function(t){return t.toLowerCase()})).indexOf(e.toLowerCase());return n>-1?n:null}};function _t(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];for(var n=0,r=e;n<r.length;n++){var s=r[n];for(var a in s)t[a]=s[a]}return t}var yt=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],vt=["January","February","March","April","May","June","July","August","September","October","November","December"],wt=gt(vt,3),bt={dayNamesShort:gt(yt,3),dayNames:yt,monthNamesShort:wt,monthNames:vt,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},St=_t({},bt),xt=function(t,e){for(void 0===e&&(e=2),t=String(t);t.length<e;)t="0"+t;return t},kt={D:function(t){return String(t.getDate())},DD:function(t){return xt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return String(t.getDay())},dd:function(t){return xt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return String(t.getMonth()+1)},MM:function(t){return xt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return xt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return xt(t.getFullYear(),4)},h:function(t){return String(t.getHours()%12||12)},hh:function(t){return xt(t.getHours()%12||12)},H:function(t){return String(t.getHours())},HH:function(t){return xt(t.getHours())},m:function(t){return String(t.getMinutes())},mm:function(t){return xt(t.getMinutes())},s:function(t){return String(t.getSeconds())},ss:function(t){return xt(t.getSeconds())},S:function(t){return String(Math.round(t.getMilliseconds()/100))},SS:function(t){return xt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return xt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+xt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)},Z:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+xt(Math.floor(Math.abs(e)/60),2)+":"+xt(Math.abs(e)%60,2)}},Pt=function(t){return+t-1},Ct=[null,"[1-9]\\d?"],Nt=[null,pt],Tt=["isPm",pt,function(t,e){var i=t.toLowerCase();return i===e.amPm[0]?0:i===e.amPm[1]?1:null}],Et=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var i=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?i:-i}return 0}],Mt=(ft("monthNamesShort"),ft("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var $t=function(t,e,i){if(void 0===e&&(e=Mt.default),void 0===i&&(i={}),"number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date pass to format");var n=[];e=(e=Mt[e]||e).replace(mt,(function(t,e){return n.push(e),"@@@"}));var r=_t(_t({},St),i);return(e=e.replace(ht,(function(e){return kt[e](t,r)}))).replace(/@@@/g,(function(){return n.shift()}))};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();var Vt=function(t,e,i,n){n=n||{},i=null==i?{}:i;var r=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return r.detail=i,t.dispatchEvent(r),r};var At={optional:"Optional",name:"Title",time_entity:"Time Entity",mode_entity:"Mode Entity",duration_entity:"Duration Entity",invalid_configuration:"Invalid configuration",required_entity_missing:"A required entity %entity% is not set",required_entity_not_found:"A required entity %entity% is not found",force_native_time_picker_for_device:"Force the native time picker in this browser"},It={alarm_mode:"Alarm Mode",alarm_duration:"Alarm Duration"},Ot={config:At,card:It},Rt=Object.freeze({__proto__:null,config:At,card:It,default:Ot}),Dt={optional:"Valgfri",name:"Tittel",time_entity:"Tidsenhet",mode_entity:"Modusenhet",duration_entity:"Varighet Enhet",invalid_configuration:"Ugyldig konfigurasjon",required_entity_missing:"En obligatorisk %entity% er ikke angitt",required_entity_not_found:"En nødvendig enhet %entity% er ikke funnet",force_native_time_picker_for_device:"Tving den opprinnelige tidsvelgeren i denne nettleseren"},Bt={alarm_mode:"Alarm Modus",alarm_duration:"Alarmens varighet"},Lt={config:Dt,card:Bt},Ut=Object.freeze({__proto__:null,config:Dt,card:Bt,default:Lt});const Yt={en:Rt,nb:Ut,no:Ut};function qt(t,e="",i=""){const n=t.split(".")[0],r=t.split(".")[1],s=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let a;try{a=Yt[s][n][r]}catch(t){a=Yt.en[n][r]}return void 0===a&&(a=Yt.en[n][r]),""!==e&&""!==i&&(a=a.replace(e,i)),a}let Ht=class extends it{setConfig(t){this._config=t}get _title(){return this._config&&this._config.name||""}get _time_entity(){return this._config&&this._config.time_entity||""}get _mode_entity(){return this._config&&this._config.mode_entity||""}get _duration_entity(){return this._config&&this._config.duration_entity||""}get _force_native_time_picker_for_device(){return"true"===localStorage.getItem("lightalarmCard.forceNativePicker")}render(){if(!this.hass)return R``;try{window.loadCardHelpers().then(t=>{t.createRowElement({type:"input-select-entity"})})}catch(t){}const t=Object.keys(this.hass.states).filter(t=>"input_datetime"===t.substr(0,t.indexOf("."))),e=Object.keys(this.hass.states).filter(t=>"input_select"===t.substr(0,t.indexOf("."))),i=Object.keys(this.hass.states).filter(t=>"input_number"===t.substr(0,t.indexOf(".")));return R`
      <div class="card-config">
        ...
        <div class="indent">
          ...
          <br />
          <paper-dropdown-menu
            label="${qt("config.duration_entity")}"
            @value-changed=${this._valueChanged}
        ...
        ></ha-switch>
        <span class="switch-label">${qt("config.force_native_time_picker_for_device")}</span>
      </div>
    ...
    `}};t([Z({attribute:!1})],Ht.prototype,"hass",void 0),t([G()],Ht.prototype,"_config",void 0),Ht=t([W("lightalarm-card-editor")],Ht);console.info("%c LIGHTALARM-CARD %c 3.0.1 ","color: cornsilk; font-weight: bold; background: firebrick","color: firebrick; font-weight: bold; background: cornsilk");let zt=class extends it{constructor(){super(...arguments),this.timeInputStatus="none"}static async getConfigElement(){return document.createElement("lightalarm-card-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error(qt("config.invalid_configuration"));if(!t.time_entity)throw new Error(qt("config.required_entity_missing","%entity%",qt("config.time_entity")));if(!t.mode_entity)throw new Error(qt("config.required_entity_missing","%entity%",qt("config.mode_entity")));if(!t.duration_entity)throw new Error(qt("config.required_entity_missing","%entity%",qt("config.duration_entity")));try{window.loadCardHelpers().then(t=>{t.createRowElement({type:"input-select-entity"})})}catch(t){}this._config=t}shouldUpdate(t){const e=function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var n=e.get("hass");return!n||n.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1);if(!e){const e=t.hass;return!e||e.states[this._config.time_entity]!==this.hass.states[this._config.time_entity]||e.states[this._config.mode_entity]!==this.hass.states[this._config.mode_entity]||e.states[this._config.duration_entity]!==this.hass.states[this._config.duration_entity]}return e}render(){if(!this._config||!this.hass)return R``;const t=this.hass.states[this._config.time_entity];if(!t)return R`
        <hui-warning
          >${this.hass.localize("config.required_entity_not_found","%entity%",this._config.time_entity)}</hui-warning
        >
      `;const e=this.hass.states[this._config.mode_entity];if(!e)return R`
        <hui-warning
          >${this.hass.localize("config.required_entity_not_found","%entity%",this._config.mode_entity)}</hui-warning
        >
      `;const i=this.hass.states[this._config.duration_entity];return i?R`
        ...
        <div class="lightalarm-wrapper" id="lightalarm-wrapper">
          ...
          <div class="alarm-properties-wrap">
            <paper-dropdown-menu
              ...
              label="${e.attributes.friendly_name||qt("card.alarm_mode")}"
            >
              <paper-listbox
            ...
            <div class="alarm-duration">
              <label slot="label" for="duration-input"
                >${i.attributes.friendly_name||qt("card.alarm_duration")}</label
              >
    ...
    `:R`
        <hui-warning
          >${this.hass.localize("config.required_entity_not_found","%entity%",this._config.duration_entity)}</hui-warning
        >
